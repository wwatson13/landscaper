...
func (s *State) Create(ctx context.Context, c client.Client, obj Object, opts ...CreateOption) error {
...
func cleanupForObject(ctx context.Context, c client.Client, obj metav1.Object) error {
	if err := c.Get(ctx, client.ObjectKey{Name: obj.GetName(), Namespace: obj.GetNamespace()}, obj.(runtime.Object)); err != nil {
		if apierrors.IsNotFound(err) {
			return nil
		}
		return err
	...
	if err := c.Delete(ctx, obj.(runtime.Object)); err != nil && !apierrors.IsNotFound(err) {
		return err
	}
	return nil
}

func removeFinalizer(ctx context.Context, c client.Client, object metav1.Object) error {
	if len(object.GetFinalizers()) == 0 {
		return nil
	}

	object.SetFinalizers([]string{})
	return c.Update(ctx, object.(runtime.Object))
}
